...
engine (``from ..state import ...``) but the engine never imports back down into ``analysis``.
    ...
    python -m imposterkings.analysis.search_scaling      # MCTS@N vs a fixed-N baseline
    python -m imposterkings.analysis.budget_scaling      # hybrid MCTS@k,l sweep vs fixed references
"""
